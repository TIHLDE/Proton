 ...
 */
export function isMultiDayEvent(event: TeamEvent): boolean {
 ...
 */
export function getEventsForDay(events: TeamEvent[], day: Date): TeamEvent[] {
	return events
		.filter((event) => {
			const eventStart = new Date(event.startAt);
 ...
 */
export function sortEvents(events: TeamEvent[]): TeamEvent[] {
